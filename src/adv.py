...
sword = Item("sword", "A relic from past eras.")
mirror = Item("mirror", "your face reflects as you stare into it.")
dagger = Item("dagger", "useful against those that want to eat you")
chicken = Item("chicken", "Cluck-Cluck")
coin = Item("coin", "Should be worth a lot!")
...
# Initialize Game
print("> Welcome to the Game. It's fun...")
print("> You are a thief searching for gold, find the treasure to win the game!")
print('')
print(
    "> Controls: [n] move north [e] move east [s] move south [w] move west [q] quit game")
print("> Tips! Try to *look* for items, *pickup* items, or *use* items!")
print('')
